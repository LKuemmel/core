...
class PreferencedParams:
    def __init__(self,
                 ...
                 soc_3: float = 50,
                 required_current_3: float = 6) -> None:
        self.name = name
        self.plug_time_1 = plug_time_1
        self.imported_since_plugged_1 = imported_since_plugged_1
        self.soc_1 = soc_1
        self.required_current_1 = required_current_1
        self.plug_time_2 = plug_time_2
        self.imported_since_plugged_2 = imported_since_plugged_2
        self.soc_2 = soc_2
        self.required_current_2 = required_current_2
        self.plug_time_3 = plug_time_3
        self.imported_since_plugged_3 = imported_since_plugged_3
        self.soc_3 = soc_3
        self.required_current_3 = required_current_3
...
def test_get_chargepoints_submode_pv_charging(submode_1, submode_2, expected_chargepoints):
    # setup
