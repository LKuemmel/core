...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(0, [8]*3, 6, [0]*3, id="min current is already set,  three phases"),
    ])
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(6, 2, 8, id="min current is set"),
        pytest.param(7, 2, 7, id="new current is higher"),
        pytest.param(9, 2, 8, id="new current is lower"),
    ])
