...
def get_preferenced_chargepoint_with_set_current_and_charging(chargepoints: List[Chargepoint]) -> List[Chargepoint]:
    ...
    return preferenced_chargepoints_with_set_current
