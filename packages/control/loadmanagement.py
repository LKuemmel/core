...
class Loadmanagement:
    def get_available_currents(self, missing_currents: List[float], counter: Counter, feed_in: int = 0) -> Tuple[List[float], Optional[LimitingValue]]:
    ...
    # tested
    def _limit_by_power(self, available_currents: List[float], raw_power_left: Optional[float], feed_in: Optional[float]) -> Tuple[List[float], Optional[LimitingValue]]:
    ...
    # tested
    def _limit_by_current(self, missing_currents: List[float], raw_currents_left: List[float]) -> Tuple[List[float], Optional[LimitingValue]]:
